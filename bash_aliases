...
alias ls='ls -F $_DF ${_colorflag}'
alias lltg='ls -lGrtF $_DF ${_colorflag}'
alias llgt='ls -lGrtF $_DF ${_colorflag}'
alias lg='ls -lGF $_DF ${_colorflag}'
alias llg='ls -lGF $_DF ${_colorflag}'
alias lt='ls -lrtF $_DF ${_colorflag}'
alias llt='ls -lrtF $_DF ${_colorflag}'

alias dot='ls -A -dF ${_DF} ${_colorflag} .[a-zA-Z0-9]*'
alias dolt='ls -A -dlF ${_DF} ${_colorflag} .[a-zA-Z0-9]*'
alias l.='ls -A -dF ${_DF} ${_colorflag} .*'
alias ll.='ls -ldF ${_DF} ${_colorflag} .*'
alias lf='/bin/ls -F ${_DF} ${_colorflag}'
alias l='/bin/ls -lGF ${_colorflag}'
alias lsa='ls -A -F ${_DF} ${_colorflag}'
alias lsp='/bin/ls -F'
# alias la='ls -AF ${_colorflag}'
alias ll='ls -lF ${_DF} ${_colorflag}'
alias lla='ls -A -lF ${_DF} ${_colorflag}'
alias lh='ls -lhF ${_DF} ${_colorflag}'
alias llh='ls -lhF ${_DF} ${_colorflag}'
# }}}
alias md='mkdir'
alias mdp='mkdir -p'
