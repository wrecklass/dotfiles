...
alias ll.='ls -lGdF ${colorflag} .*'
alias l=less
alias lesb='$(history -p !!) | less'
alias ls='ls -F ${colorflag}'
alias lsp='\ls -F'
alias la='ls -AF ${colorflag}'
alias ll='ls -lGF ${colorflag}'
alias lla='ls -lGFa ${colorflag}'
alias lh='ls -lGhF ${colorflag}'
alias llh='ls -lGhF ${colorflag}'
alias lt='ls -lGrtF ${colorflag}'
alias llt='ls -lGrtF ${colorflag}'
